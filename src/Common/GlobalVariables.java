...
public class GlobalVariables {
    ...
    public final static double DEFAULT_TOPIC_NODE_WIDTH = 145;
    public final static double DEFAULT_TOPIC_NODE_HEIGHT = 90;
    public final static double BRANCH_NODE_WIDTH = 100;
    public final static double BRANCH_NODE_HEIGHT = 70;
